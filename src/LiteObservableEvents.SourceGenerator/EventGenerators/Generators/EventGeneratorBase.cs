...
{
    /// <inheritdoc/>
    public abstract NamespaceDeclarationSyntax? Generate(INamedTypeSymbol item, Func<string?, INamedTypeSymbol?> getSymbolOf);
    ...
    private static (ArrowExpressionClauseSyntax ArrowClause, TypeSyntax EventArgsType) GenerateFromEventExpression(IEventSymbol eventSymbol, string dataObjectName)
    {
        ...
        // Produces: => global::System.Reactive.Linq.Observable.Create<eventArgsType>(obs =>
        // {
        ...
        var expression = ArrowExpressionClause(InvocationExpression(
            MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, "global::System.Reactive.Linq.Observable", GenericName("Create", [eventArgsType])),
            [
