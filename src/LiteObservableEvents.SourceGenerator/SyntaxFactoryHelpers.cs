...
internal static class SyntaxFactoryHelpers
{
    ...
    {
        var rank = rankSpecifiers == null || rankSpecifiers.Count == 0 ? List([ArrayRankSpecifier()]) : List(rankSpecifiers);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FieldDeclarationSyntax FieldDeclaration(TypeSyntax type, string name, IReadOnlyCollection<SyntaxKind>? modifiers, int level) => FieldDeclaration(type, name, [], modifiers, level);
    ...
    public static FieldDeclarationSyntax FieldDeclaration(TypeSyntax type, string name, IReadOnlyCollection<AttributeListSyntax>? attributes, IReadOnlyCollection<SyntaxKind>? modifiers, int level)
    {
        ...
        var variableDeclaration = VariableDeclaration(type, SeparatedList([VariableDeclarator(name)]));
    ...
    public static FieldDeclarationSyntax FieldDeclaration(TypeSyntax type, string name, EqualsValueClauseSyntax initializer, IReadOnlyCollection<AttributeListSyntax>? attributes, IReadOnlyCollection<SyntaxKind> modifiers, int level)
    {
        ...
        var variableDeclaration = VariableDeclaration(type, SeparatedList([VariableDeclarator(name, initializer)]));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(IReadOnlyCollection<TNode> nodes, int level)
        where TNode : SyntaxNode
    {
        if (nodes == null || nodes.Count == 0)
        {
